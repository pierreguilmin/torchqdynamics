...
def jsmesolve(
    ...
    *,
    ...
    Returns:
        [`dq.JSMESolveResult`][dynamiqs.JSMESolveResult] object holding the result of
            the jump SME integration. Use the attributes `states`, `clicktimes`
            and `expects` to access saved quantities, more details in
            [`dq.JSMESolveResult`][dynamiqs.JSMESolveResult].
    """  # noqa: E501
